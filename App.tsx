        ...
        {!data && !loading && (
          <div className="max-w-3xl mx-auto text-center py-20 animate-in fade-in slide-in-from-bottom-4 duration-500">
            ...
            <p className="text-lg text-gray-500 mb-12 max-w-xl mx-auto">
              Transform your raw student records into actionable pedagogical intelligence. Class rankings, school comparisons, and individual progress tracking in seconds.
            </p>
            <FileUpload onDataLoaded={setData} setLoading={setLoading} />
          </div>
        )}
