...
const translations: Record<Language, TranslationDict> = {
  zh: {
    ...
    'manager.btn_delete_selected': '删除选中',
    'manager.batch_delete_confirm': '⚠️ 警告：您即将永久删除所选的 {count} 个考试相关的所有数据。\n\n您确定要继续吗？',
  ...
  en: {
    ...
    'manager.btn_delete_selected': 'Delete Selected',
    'manager.batch_delete_confirm': '⚠️ Warning: You are about to permanently delete all data related to the selected {count} exams. \n\nAre you sure you want to proceed?',
