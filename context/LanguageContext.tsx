...
const translations: Record<Language, TranslationDict> = {
  zh: {
    ...
    'export.subtitle': '生成、预览并导出可打印的成绩分析报告',
    'export.config_period': '选择考试周期',
    'export.config_classes': '班级范围',
    'export.options_title': '报告内容选项',
  ...
  en: {
    ...
    'export.subtitle': 'Generate, preview and export printable academic reports',
    'export.config_period': 'Select Exam Period',
    'export.config_classes': 'Class Range',
    'export.options_title': 'Report Content Options',
